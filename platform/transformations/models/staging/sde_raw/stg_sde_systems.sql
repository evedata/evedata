with
    ...
    renamed as (
        select
            ...
            secondary_sun__position__x::decimal as secondary_sun_position_x,
            secondary_sun__position__y::decimal as secondary_sun_position_y,
            secondary_sun__position__z::decimal as secondary_sun_position_z,
            security::decimal as security_status,
            star__radius::bigint as star_radius,
            star__statistics__age::decimal as star_statistics_age,
            star__statistics__life::decimal as star_statistics_life,
