with
    source as (select * from {{ source("sde_raw", "market_groups") }}),

    renamed as (
        select

            -- -------- IDs
            _dlt_id::text as market_group_uuid,
            id::bigint as market_group_id,
            parent_group_id::bigint as parent_market_group_id,
