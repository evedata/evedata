...
from evedata_reference.dlt.sources._esi._client import ESIClient
from evedata_reference.dlt.sources._utils import before_load, process_data
...
if TYPE_CHECKING:
    ...
    from evedata_reference.dlt.sources._types import ESIResourceConfig
