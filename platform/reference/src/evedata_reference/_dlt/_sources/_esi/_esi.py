...
from evedata_reference._dlt._sources._esi._client import ESIClient
from evedata_reference._utils._sources import before_load, process_data
...
if TYPE_CHECKING:
    ...
    from evedata_reference._types import ESIResourceConfig
