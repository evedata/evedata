...
#     current_hoboleaks_version = latest_hde_version()
#     current_archive_version = latest_archive_version(config)
...
#     create_archive(config, overwrite=force)
...
#     if version is None:
#         version = latest_archive_version(config)
#         if version is None:
